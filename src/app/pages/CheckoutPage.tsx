...
export function CheckoutPage() {
  ...
  const activeAddress: IShippingAddressPayload | null = showNewForm
    ? newAddress
    : selectedIdx !== null ? savedAddresses[selectedIdx] : null;
  ...
  const initiatePayment = async () => {
    ...
    try {
      ...
      const { razorpayOrderId, amount, baseAmount, shippingCost: serverShipping, orderItems, shippingAddress } = createRes.data;
  ...
  const handleAuthSuccess = () => {
    ...
    // small delay to let user state settle after login
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    return (
                      <div key={item.id} className="flex gap-4 items-center">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-neutral-500 mt-0.5">{item.sizeLabel} × {item.quantity}</p>
                        </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-neutral-100 sticky top-24">
                ...
                {!user && (
                  <div className="mb-4 p-3 bg-neutral-50 border border-neutral-200 rounded-xl text-xs text-neutral-500 text-center">
